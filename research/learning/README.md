...
| 05 | [`05-phases-and-proofs.md`](./05-phases-and-proofs.md) | What each phase delivered and the numbers that prove it (MTTR −63.6%, RPO=0, recall@10=1.0, temporal-validity 1.0). |
